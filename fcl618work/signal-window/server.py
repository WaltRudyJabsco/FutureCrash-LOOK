#!/usr/bin/env python3
"""Signal Window 1.10.3 — accountless authorized Fabric browser endpoint."""
...
def main():
    ...
    print(f"Signal Window 1.10.3 · http://{a.host}:{a.port} · {state} · gallery {App.gallery_dir if App.gallery_enabled else 'off'}")
