...
PRODUCT_VERSION="2.7.7"
LOOK_VERSION="4.8.1"
FUTURE_CRASH_VERSION="1.1.12"
...
manifest = {
    ...
    "release": os.environ.get("FCL_RELEASE_VERSION", "2.7.7"),
    "components": {
        "look": os.environ.get("FCL_LOOK_VERSION", "4.8.1"),
        "future_crash": os.environ.get("FCL_FUTURE_CRASH_VERSION", "1.1.12"),
    },
