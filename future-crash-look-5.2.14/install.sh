...
echo "Future Crash + LOOK 5.2.14 · Shared Fabric UI Model"
echo "────────────────────────────────────────"
...
if ((DRY_RUN)); then
  echo
  echo "[dry-run] would install/restart Unified Node 5.2.14, Shared Fabric UI Model, Vision Artifacts, Fabric Memory, and Signal Window 1.1.2"
